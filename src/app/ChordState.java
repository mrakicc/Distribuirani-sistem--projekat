...
public class ChordState {
	...
	private List<MyFile> fileStorage;
	...
	public void addFileToStorage(String fileName, String fileContent, boolean isPublic, String path) {
		MyFile fileInfo = new MyFile(fileName, path ,fileContent, isPublic);
		fileStorage.add(fileInfo);
		AppConfig.timestampedStandardPrint("File: " + path + " " +  " Public: " + isPublic + " stored on node: " + AppConfig.myServentInfo.getChordId());
	}

	public MyFile getFileFromStorage(String fileName) {
		for (MyFile fileInfo : fileStorage) {
	...
	public void removeFileFromStorage(String fileName) {
		MyFile fileInfo = getFileFromStorage(fileName);
		if (fileInfo != null) {
			fileStorage.remove(fileInfo);
			AppConfig.timestampedStandardPrint("File removed from node: " + AppConfig.myServentInfo.getChordId() + " (File: " + fileInfo.getFilePath() + ")");
		}
	}

	public void addFriend(ServentInfo friend) {
		AppConfig.timestampedStandardPrint("Friend added: " + friend.getChordId());
		friends.add(friend);
	}
	...
	public List<MyFile> getFileStorage() {
		return fileStorage;
	}
